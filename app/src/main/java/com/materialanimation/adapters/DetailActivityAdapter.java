...
/**
 * Created by mitual.sheth on 01-Dec-17.
 */

public class DetailActivityAdapter extends RecyclerView.Adapter<DetailActivityAdapter.MyViewHolder>{
    ...
    public DetailActivityAdapter(Context context, List<Image> images, ItemClickListener onItemClickListener) {
        mContext = context;
        this.images = images;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_detail_sports, parent, false);
